...
## Finder submission status

Online finder submission is **not yet enabled**.

The current live end state is intentionally truthful and conservative:

1. Complete the finder through to the Review page.
2. Confirm that you understand no information will be transmitted.
3. Click **Prepare request summary**.
4. The finder shows **"Your request summary is ready"** and explains that no information has been transmitted.
5. Available actions are **Copy request summary**, **Print or save summary**, **Improve identification**, and **Start again**.

This keeps the enquiry workflow transparent while request routing is still under development.
